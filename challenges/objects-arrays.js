...
console.log(tyrannoObject.weight);

// What was the diet of a velociraptor?
console.log(velociObject.diet);

// How long was a stegosaurus?
console.log(stegoObject.length);

// What time period did tyrannosaurus live in?
console.log(tyrannoObject.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(tyrannoObject.roarMethod());
...
zooAnimals.map(function (item) {
     lowerCase.push('Animal Lowercase: ' + item.animal_name.toLowerCase())});
...
zooAnimals.filter(function (item) {
    ...
    if (item.population < 5) {
        return lowerPopulation.push(item.animal_name + ' | ' + 
        'POPULATION: ' +
        item.population)
    }
...
const totalPop = zooAnimals.reduce(function (accumulator, pop) {
